...
using ssptb.pe.tdlt.storage.api.Configuration.Security;
...
using ssptb.pe.tdlt.storage.dto.Mapster;
using ssptb.pe.tdlt.storage.secretsmanager.Services;
using Swashbuckle.AspNetCore.SwaggerGen;
using ssptb.pe.tdlt.storage.data.HealthCheck;

namespace ssptb.pe.tdlt.storage.api;
...
public static class ProgramExtesions
{
    ...
    public static IServiceCollection AddSecretsConfiguration(this IServiceCollection services, WebApplicationBuilder builder)
    {
        ...
        {
            options.ConnectionString = secretsCouchBase.ConnectionString;
            options.BucketName = secretsCouchBase.BucketName;
            options.UserName = secretsCouchBase.UserName;
